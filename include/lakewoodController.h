	...
	namespace Lakewood 
	{
		...
		public:
			...
			Steinberg::tresult PLUGIN_API getMidiControllerAssignment (
					...
					Steinberg::Vst::ParamID ParamID & 	id) SMTG_OVERRIDE;
			*/
			//------------------------------------------------------------------------
			//---from IMidiMapping---
			...
			Steinberg::tresult PLUGIN_API getNoteExpressionInfo (
				...
				Steinberg::Vst::NoteExpressionTypeInfo& info) SMTG_OVERRIDE;
			//------------------------------------------------------------------------
			...
			Steinberg::tresult PLUGIN_API getNoteExpressionValueByString (
				...
				Steinberg::Vst::NoteExpressionValue& valueNormalized) SMTG_OVERRIDE;
			*/
		};
	} // namespace Lakewood
} // namespace Carlsound
